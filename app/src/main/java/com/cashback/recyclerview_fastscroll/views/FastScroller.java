...
package com.cashback.recyclerview_fastscroll.views;
...
import com.cashback.recyclerview_fastscroll.interfaces.OnFastScrollStateChangeListener;
import com.cashback.recyclerview_fastscroll.utils.Utils;
...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mWidthBar = Utils.toPixels(resources, 4);
        offsetbar=(mWidth/2)-(mWidthBar/2);
        ...
        try {
            ...
            temp.setColor(Color.TRANSPARENT);
    ...
    public void draw(Canvas canvas) {
        ...
        //Background
        canvas.drawRect(mThumbPosition.x + mOffset.x, mThumbHeight / 2 + mOffset.y, mThumbPosition.x + mOffset.x + mWidth, mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2, temp);
        canvas.drawRect(mThumbPosition.x + mOffset.x+ offsetbar, mThumbHeight / 2 + mOffset.y, mThumbPosition.x + mOffset.x + mWidthBar, mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2, mTrack);
        //Handle
        float pos=mThumbPosition.y + mOffset.y<mThumbHeight / 2 + mOffset.y?(mThumbHeight / 2 + mOffset.y):mThumbPosition.y + mOffset.y;
            pos= pos+ mThumbHeight>mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2?mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2-mThumbHeight:pos;
        canvas.drawRect(mThumbPosition.x + mOffset.x,pos, mThumbPosition.x + mOffset.x + mWidth, pos+ mThumbHeight, mThumb);
