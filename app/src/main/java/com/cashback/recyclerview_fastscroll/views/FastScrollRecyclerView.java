...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    public String scrollToPositionAtProgress(float touchFraction) {
        ...
        getCurScrollState(mScrollPosState, 0);
    ...
    public void onUpdateScrollbar() {
        ...
        getCurScrollState(mScrollPosState, mScrollPosState.rowIndex);
     ...
     */
    private void getCurScrollState(ScrollPositionState stateOut, int pos) {
        stateOut.rowIndex = -1;
        ...
        if (currentRowHeight != 0) {
            stateOut.rowHeight = currentRowHeight;
        } else
            stateOut.rowHeight = ((child.getHeight())) + ((getLayoutManager().getTopDecorationHeight(child) + getLayoutManager().getTopDecorationHeight(child2)) / 2)
                    + ((getLayoutManager().getBottomDecorationHeight(child) + getLayoutManager().getBottomDecorationHeight(child2)) / 2) - 2;
        currentRowHeight = stateOut.rowHeight;
